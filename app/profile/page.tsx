...
async function page() {
  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen bg-primary py-10'>
      <div className='bg-white py-10 flex flex-col rounded-lg shadow-lg w-full max-w-xl '>
